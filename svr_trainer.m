...
ret =  @(x) cellfun(@(u) svr_eval(u),num2cell(x,2));
...
% for s=1:size(xdata,1)
%     if(alpha(s)>-0.5 & alpha(s)<0.5)
%         alphanew(s) = alpha(s);
